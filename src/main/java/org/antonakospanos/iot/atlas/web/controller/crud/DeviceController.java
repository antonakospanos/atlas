...
public class DeviceController extends BaseAtlasController {
	...
	public ResponseEntity<Iterable> listDevices(@PathVariable (required=false) String deviceId, @RequestParam (required=false) String username) {
		logger.debug(LoggingHelper.logInboundRequest("/devices/" + deviceId + "?username=" + username));
	...
	public ResponseEntity<Iterable> listAccountDevices(@PathVariable (required=true) String username, @PathVariable (required=false) String deviceId) {
